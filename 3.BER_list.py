...
def main_base(nSymbolVector = 2,kinds = 10,n=50,m=32):
    crnstd_G512 = 0.0360

    # P4 = {'Vb1': 8.952923874852276,
    #           'Vb2': 8.809128541552289,
    #           'R1': 1.2759552656515063,
    #           'R2': 150.34023995986234,
    #           'R3': 21.14190038554824,
    #           'sort_key': 0.00257}
    ...
    # 1.绘制BER_list
    calculate_BER_noise(R1, Vb1, Vb2, R2, R3, nSymbolVector=nSymbolVector, arrSNR = list(np.arange(0, 30.01, 2.5)), func=2, kinds=kinds,
                        noise=-1,
                        std=crnstd_G512, thermal1=0, thermal2=0, shot=0, on=1,n=n, m=m)
...
def main_B(nSymbolVector = 2,kinds = 10,n=50,m=32):
    # Pb4 = {'Vb1': 1.731197670202547,
    #        'Vb2': 0.990354064244202,
    #        'R1': 1.1956336199482325,
    #        'R2': 29.056675522050863,
    #        'sort_key': 0.00065}
    ...
    calculate_BER_noise(R1, Vb1, Vb2, R2, R3, nSymbolVector=nSymbolVector, arrSNR=list(np.arange(0,30.01,2.5)) ,func=1, kinds=kinds,
                                noise=-1,
                                std=crnstd_G512, thermal1=std_thermal_OE_drs, thermal2=std_thermal_EO_drs,
                                shot=var_shot_st,on=1,
                                n=n,m=m
                        )
...
#
#     R3 = 1e2000
    # main_base(nSymbolVector = 2,kinds = 10000)
